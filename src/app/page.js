    ...
    <div class='relative mobile-bg h-screen'>
      ...
      <div class='w-full h-screen flex flex-col xl:gap-y-0 gap-y-[40px] xl:flex-row items-center justify-center xl:justify-between relative'>
        <div class='flex justify-center p-6 xl:w-[50vw] xl:pl-[12.5%] flex-col gap-y-[40px] items-center xl:items-start'>
          ...
          <a href="https://github.com/samdonks" class="bg-[#4E4E50] w-[40px] flex flex-col items-center justify-center h-[40px] rounded-full" aria-label="Visit My GitHub Profile">
      ...
      >
        <div className="flex basis-full flex-col tracking-tight text-slate-100/50 sm:basis-1/2 w-[554px] h-[334px] ">
          <div className="flex flex-1 w-full rounded-lg ">
            <Link href='https://wwww.visionbot.cx'>
          ...
          <div class='flex flex-col items-start gap-y-2'>
            ...
            >
              ...
              >
                <div className="flex basis-full flex-col tracking-tight text-slate-100/50 sm:basis-1/2 w-[554px] h-[334px] ">
                  <div className="flex flex-1 w-full rounded-lg ">
                  <Link href='https://www.reflect.app'>
                    <img src="/assets/reflecttest.png" class='' alt="Project2" loading='lazy' />
        ...
        <div class='flex flex-col lg:gap-y-6 md:gap-y-6 sm:gap-y-6 lg:flex-row justify-between w-full my-12'>
          <div class='flex flex-col items-start gap-y-2 mb-12'>
            ...
            >
              <PinContainer
                title="URL Shortener"
                href="https://urlshortener-sigma-seven.vercel.app/"
              >
                <div className="flex basis-full flex-col tracking-tight text-slate-100/50 sm:basis-1/2 w-[554px] h-[334px] ">
                  <div className="flex flex-1 w-full rounded-lg ">
                    <Link href="https://urlshortener-sigma-seven.vercel.app/">
                    <img src="/assets/urlshortener.png" alt="Project2" loading="lazy" />
                    <source srcSet="/assets/urlshortener.webp" type="image/webp" />
                    </Link>
                  </div>
                </div>
              </PinContainer>
              <p class='text-[14px] font-bold text-[#A6ACBB] pt-10'>URLShortener</p>
              <div class="flex flex-row gap-x-4 pt-1 pb-2">
              <div class="bg-[#4E4E50]/20 text-[#4E4E50] text-[14px] px-2 py-1 rounded-md flex flex-col items-center hover:text-[#00ff66]">NextJS</div>
                ...
                <div class="bg-[#4E4E50]/20 text-[#4E4E50] text-[14px] px-2 py-1 rounded-md flex flex-col items-center hover:text-[#00ff66]">Planetscale</div>
              </div>
            </motion.div>
          </div>
          ...
          <div class='flex flex-col items-start gap-y-2'>
            ...
            >
              ...
              >
                <div className="flex basis-full flex-col tracking-tight text-slate-100/50 sm:basis-1/2 w-[554px] h-[334px] ">
                  <div className="flex flex-1 w-full rounded-lg ">
                    <Link href='https://www.spearproxies.com'>
                    <img src="/assets/spear.png" class='' alt="Project2" loading='lazy' />
        ...
        <div class='flex flex-col lg:gap-y-6 md:gap-y-6 sm:gap-y-6 lg:flex-row justify-between w-full my-12'>
          <div class='flex flex-col items-start gap-y-2 mb-12'>
            ...
            >
              ...
              >
                <div className="flex basis-full flex-col tracking-tight text-slate-100/50 sm:basis-1/2 w-[554px] h-[334px] ">
                  <div className="flex flex-1 w-full rounded-lg ">
                    <Link href='https://dashboard.lemonclub.io/dashboard#static'>
          ...
          <div class='flex flex-col items-start gap-y-2'>
            ...
            >
              ...
              <p class='text-[14px] font-bold text-[#A6ACBB] pt-10'>EcommerceStore</p>
              <div class="flex flex-row gap-x-4 pt-1">
                <div class="bg-[#4E4E50]/20 text-[#4E4E50] text-[14px] px-2 py-1 rounded-md flex flex-col items-center hover:text-[#00ff66]">React</div>
                <div class="bg-[#4E4E50]/20 text-[#4E4E50] text-[14px] px-2 py-1 rounded-md flex flex-col items-center hover:text-[#00ff66]">Simple UI</div>
                <div class="bg-[#4E4E50]/20 text-[#4E4E50] text-[14px] px-2 py-1 rounded-md flex flex-col items-center hover:text-[#00ff66]">NodeJS</div>
                <div class="bg-[#4E4E50]/20 text-[#4E4E50] text-[14px] px-2 py-1 rounded-md flex flex-col items-center hover:text-[#00ff66]">MySQL</div>
              </div>
            </motion.div>
        ...
        <div id='contact' class='flex flex-col lg:gap-0 gap-6 lg:flex-row w-full justify-between max-w-7xl mx-auto px-6 pb-12'>
          <div class="flex flex-col items-start">
            <div class="flex flex-col items-start gap-y-2 mb-6">
              ...
              <p class="text-white text-[14px] max-w-[450px] text-left">Reach out to me if you need any help, have questions, or you are ready to start building your<span class="animated-text font-bold"> Dream Project.</span></p></div>
              <div class="flex flex-col items-start gap-y-2 mb-6">
